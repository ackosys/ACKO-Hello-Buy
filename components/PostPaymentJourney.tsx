...
/* ═══════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════ */
const LANG_OPTIONS: Language[] = ['en', 'hi', 'hinglish', 'kn', 'ta', 'ml', 'te'];
const LANG_LABEL_KEYS: Record<Language, 'english' | 'hindi' | 'hinglish' | 'kannada' | 'tamil' | 'malayalam' | 'telugu'> = {
  en: 'english', hi: 'hindi', hinglish: 'hinglish', kn: 'kannada', ta: 'tamil', ml: 'malayalam', te: 'telugu',
};
  ...
  const header = (
    <div className="border-b border-white/10 px-5 py-3 flex items-center justify-between shrink-0">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <button onClick={() => updateState({ showHelpPanel: true, helpPanelTab: 'chat' } as any)} className="w-8 h-8 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors" title="Expert Help">
