        ...
        {open && (
          ...
          >
            ...
            <div className="p-2">
              <button
                onClick={() => { setOpen(false); }}
                className="w-full flex items-center gap-3 p-3 rounded-xl hover:opacity-80 transition-colors text-left"
              >
                <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: 'var(--color-primary-subtle, #F3E8FF)' }}>
                  <svg className="w-5 h-5" style={{ color: 'var(--color-text-brand, #9333EA)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
              ...
              <button
                ...
                className="w-full flex items-center gap-3 p-3 rounded-xl hover:opacity-80 transition-colors text-left"
              >
                <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: 'var(--color-info-subtle, #EFF6FF)' }}>
                  <svg className="w-5 h-5" style={{ color: 'var(--color-info-text, #2563EB)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
              ...
              <button
                ...
                className="w-full flex items-center gap-3 p-3 rounded-xl hover:opacity-80 transition-colors text-left"
              >
                <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: 'var(--color-success-subtle, #F0FDF4)' }}>
                  <svg className="w-5 h-5" style={{ color: 'var(--color-success-text, #16A34A)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
